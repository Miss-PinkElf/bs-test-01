...
Assert-Equals -Label "sensor_data Jan-Apr only" -Actual (Invoke-MySqlScalar "SELECT COUNT(*) FROM sensor_data WHERE warehouse_id IN (1,2,6) AND metric_code IN ('humidity','co2') AND (collected_at < '2026-01-01 00:00:00' OR collected_at > '2026-04-30 23:59:59');") -Expected "0"
Assert-Equals -Label "sensor_data legacy September rows removed" -Actual (Invoke-MySqlScalar "SELECT COUNT(*) FROM sensor_data WHERE collected_at >= '2026-09-01 00:00:00';") -Expected "0"
...
Assert-Equals -Label "grain_temp legacy September rows removed" -Actual (Invoke-MySqlScalar "SELECT COUNT(*) FROM grain_temp_record WHERE collected_at >= '2026-09-01 00:00:00';") -Expected "0"
...
Assert-Equals -Label "prediction train window anchored to Jan-Apr" -Actual (Invoke-MySqlScalar "SELECT COUNT(*) FROM prediction_task WHERE train_start_time = '2026-01-01 00:00:00' AND train_end_time = '2026-04-30 23:59:59' AND based_on_actual_end_time = '2026-04-30 23:59:59';") -Expected "3"
Assert-Equals -Label "prediction forecast window starts after Apr baseline" -Actual (Invoke-MySqlScalar "SELECT COUNT(*) FROM prediction_task WHERE forecast_start_time < '2026-05-01 00:00:00';") -Expected "0"
...
Assert-Equals -Label "prediction_result legacy September rows removed" -Actual (Invoke-MySqlScalar "SELECT COUNT(*) FROM prediction_result WHERE result_time >= '2026-09-01 00:00:00';") -Expected "0"
