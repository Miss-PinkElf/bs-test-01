...
Intel system is disabled. To activate:
  ...
  node E:/Learn/Vs/Code/bs-test-01/.cursor/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node E:/Learn/Vs/Code/bs-test-01/.cursor/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node E:/Learn/Vs/Code/bs-test-01/.cursor/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node E:/Learn/Vs/Code/bs-test-01/.cursor/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: E:/Learn/Vs/Code/bs-test-01/.cursor/get-shit-done/bin/gsd-tools.cjs
