...
Use template from `E:/Learn/Vs/Code/bs-test-01/.cursor/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `E:/Learn/Vs/Code/bs-test-01/.cursor/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "E:/Learn/Vs/Code/bs-test-01/.cursor/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
