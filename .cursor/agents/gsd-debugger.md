...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = E:/Learn/Vs/Code/bs-test-01/.cursor
                  → checks E:/Learn/Vs/Code/bs-test-01/.cursor/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = E:/Learn/Vs/Code/bs-test-01/.cursor/get-shit-done
                  → writes to E:/Learn/Vs/Code/bs-test-01/.cursor/get-shit-done/hooks/
...
@E:/Learn/Vs/Code/bs-test-01/.cursor/get-shit-done/references/thinking-models-debug.md
...
- Read @E:/Learn/Vs/Code/bs-test-01/.cursor/get-shit-done/references/common-bug-patterns.md
...
```bash
node "E:/Learn/Vs/Code/bs-test-01/.cursor/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "E:/Learn/Vs/Code/bs-test-01/.cursor/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
