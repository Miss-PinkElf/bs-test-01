...
| `.devflow/grain-platform-bootstrap/state.md` | 当前 mission 状态真相源 | 高 |
| `.devflow/grain-platform-bootstrap/handoffs/2026-04-06-005-startup-scripts-and-resume-ready.md` | 本轮可恢复交接 | 最高 |
...
5. 必要时补读：
   ...
   - `.devflow/grain-platform-bootstrap/handoffs/2026-04-06-004-backend-real-persistence-resume-ready.md`
