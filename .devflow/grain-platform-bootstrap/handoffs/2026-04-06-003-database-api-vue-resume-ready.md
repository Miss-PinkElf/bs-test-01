...
- [x] 完成前端依赖安装与构建验证
- [x] 同步更新 `.devflow/grain-platform-bootstrap` 下的 state / decision-log / checkpoints / spec
...
| 后端设计文档统一沉淀到 `zzz-docs/设计文档/` | 分散写到 README 或 `.devflow/` | 用户明确要求后端数据设计和接口设计都沉淀到该目录，便于集中查阅 |

## 关键文件 / 产物

| 文件 | 作用 | 相关性 |
| --- | --- | --- |
| [开发指导版PRD-粮仓环境数据预测管理平台.md](E:\Learn\Vs\Code\bs-test-01\zzz-docs\开发指导版PRD-粮仓环境数据预测管理平台.md) | 后续开发总蓝图 | 最高 |
| [数据库设计定稿.md](E:\Learn\Vs\Code\bs-test-01\zzz-docs\设计文档\数据库设计定稿.md) | 正式数据库真相源 | 最高 |
| [后端接口与DTO-VO-Mapper设计.md](E:\Learn\Vs\Code\bs-test-01\zzz-docs\设计文档\后端接口与DTO-VO-Mapper设计.md) | 正式接口与后端分层设计真相源 | 最高 |
| [schema.sql](E:\Learn\Vs\Code\bs-test-01\backend\src\main\resources\db\schema.sql) | 数据库正式 SQL | 最高 |
| [design.md](E:\Learn\Vs\Code\bs-test-01\.devflow\grain-platform-bootstrap\spec\design.md) | 当前 mission 的结构与接口摘要 | 高 |
| [tasks.md](E:\Learn\Vs\Code\bs-test-01\.devflow\grain-platform-bootstrap\spec\tasks.md) | 当前 mission 的任务状态 | 高 |
| [frontend-next/README.md](E:\Learn\Vs\Code\bs-test-01\frontend-next\README.md) | 静态原型定位说明，避免误把 Next 原型当正式前端 | 高 |
| [ConsoleLayout.vue](E:\Learn\Vs\Code\bs-test-01\frontend\src\layout\ConsoleLayout.vue) | 正式前端后台布局入口 | 高 |
| [grain.js](E:\Learn\Vs\Code\bs-test-01\frontend\src\api\grain.js) | 前端 API 适配层，兼容当前 demo 后端返回结构 | 高 |
...
4. 必要时读取 `.devflow/grain-platform-bootstrap/spec/design.md` 与 `.devflow/grain-platform-bootstrap/spec/tasks.md`
