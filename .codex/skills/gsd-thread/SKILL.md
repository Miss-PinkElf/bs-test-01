...
5. Commit:
   ```bash
   node "D:/Users/Mobius/Desktop/mine/AAA-code/bs-test-01/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: create thread — ${ARGUMENTS}" --files ".planning/threads/${SLUG}.md"
   ```
