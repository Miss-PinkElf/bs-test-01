...
@E:/Learn/Vs/Code/bs-test-01/.codex/get-shit-done/references/thinking-models-execution.md
...
**See @E:/Learn/Vs/Code/bs-test-01/.codex/get-shit-done/references/checkpoints.md**
...
```bash
node E:/Learn/Vs/Code/bs-test-01/.codex/get-shit-done/bin/gsd-tools.cjs commit-to-subrepo "{type}({phase}-{plan}): {concise task description}" --files file1 file2 ...
```
...
**Use template:** @E:/Learn/Vs/Code/bs-test-01/.codex/get-shit-done/templates/summary.md
...
node "E:/Learn/Vs/Code/bs-test-01/.codex/get-shit-done/bin/gsd-tools.cjs" roadmap update-plan-progress "${PHASE_NUMBER}"
...
```bash
node "E:/Learn/Vs/Code/bs-test-01/.codex/get-shit-done/bin/gsd-tools.cjs" state add-blocker "Blocker description"
```
</state_updates>
