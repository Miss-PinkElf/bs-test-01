...
<reference>
@E:/Learn/Vs/Code/bs-test-01/.codex/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `E:/Learn/Vs/Code/bs-test-01/.codex/get-shit-done/references/user-profiling.md` to load:
