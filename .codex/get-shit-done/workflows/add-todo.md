...
```bash
INIT=$(node "E:/Learn/Vs/Code/bs-test-01/.codex/get-shit-done/bin/gsd-tools.cjs" init todos)
...
```bash
slug=$(node "E:/Learn/Vs/Code/bs-test-01/.codex/get-shit-done/bin/gsd-tools.cjs" generate-slug "$title" --raw)
```
...
```bash
node "E:/Learn/Vs/Code/bs-test-01/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: capture todo - [title]" --files .planning/todos/pending/[filename] .planning/STATE.md
```
