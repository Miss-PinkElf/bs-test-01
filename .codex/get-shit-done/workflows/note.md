...
- **Global scope**: `E:/Learn/Vs/Code/bs-test-01/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `E:/Learn/Vs/Code/bs-test-01/.codex/notes/`)
...
2. Glob `E:/Learn/Vs/Code/bs-test-01/.codex/notes/*.md` (if directory exists) — global notes
...
Global (E:/Learn/Vs/Code/bs-test-01/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `E:/Learn/Vs/Code/bs-test-01/.codex/notes/` — works in any directory
