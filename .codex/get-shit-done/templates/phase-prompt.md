...
<!-- For checkpoint task examples and patterns, see @E:/Learn/Vs/Code/bs-test-01/.codex/get-shit-done/references/checkpoints.md -->
...
See `E:/Learn/Vs/Code/bs-test-01/.codex/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `E:/Learn/Vs/Code/bs-test-01/.codex/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `E:/Learn/Vs/Code/bs-test-01/.codex/get-shit-done/workflows/verify-phase.md` for verification logic.
