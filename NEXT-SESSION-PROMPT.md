...
4. 读取 `.explore/grain-platform-bootstrap/handoffs/2026-04-06-005-startup-scripts-and-resume-ready.md`
5. 读取 `.explore/grain-platform-bootstrap/handoffs/2026-04-06-004-backend-real-persistence-resume-ready.md`
6. 读取 `.explore/grain-docs-alignment/state.md` 和 `.explore/grain-platform-bootstrap/state.md`
7. 读取 `zzz-docs/设计文档/数据库设计定稿.md`
8. 读取 `zzz-docs/设计文档/后端接口与DTO-VO-Mapper设计.md`
9. 读取 `frontend-next/README.md`
10. 读取 `NEXT-SESSION-PROMPT.md` 自身，确认本轮恢复目标
...
默认下一步任务：
1. 先验证 Windows / mac 两套启动脚本是否都能正常拉起前后端
2. 确认前端是否已成功请求 `http://localhost:8081`
3. 开始把 `frontend/` 当前兼容态页面逐步切到真实 API
4. 优先联调登录、仓库、环境数据、预测四个页面
