...
Intel system is disabled. To activate:
  ...
  node D:/Users/Mobius/Desktop/mine/AAA-code/bs-test-01/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node D:/Users/Mobius/Desktop/mine/AAA-code/bs-test-01/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node D:/Users/Mobius/Desktop/mine/AAA-code/bs-test-01/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node D:/Users/Mobius/Desktop/mine/AAA-code/bs-test-01/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: D:/Users/Mobius/Desktop/mine/AAA-code/bs-test-01/.claude/get-shit-done/bin/gsd-tools.cjs
